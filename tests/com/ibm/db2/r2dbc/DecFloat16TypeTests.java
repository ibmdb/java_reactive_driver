...
public class DecFloat16TypeTests extends BaseTestCase
{
	private static final Logger _logger =  LoggerFactory.getLogger(DecFloat16TypeTests.class.getName());

	public DecFloat16TypeTests()
	{
		super();
	...
	public static void createTable()
	{
		...
		Mono<Void> mono = getNewConnection()
								...
								.flatMap(c -> c.executeUpdate("CREATE TABLE UNIT_TEST_"+_randomInt + " (ID INTEGER, AMOUNT DECFLOAT(16) NOT NULL, ALIAS_AMOUNT DECFLOAT(16))"));
	...
	public void test001CreateTableWithDecimalColumn()
	{
		...
		Mono<Void> mono = getNewConnection()
								.doOnNext(c -> con.set(c))
								.flatMap(c -> c.executeUpdate("CREATE TABLE UNIT_TEST_1_"+_randomInt + " (ID DECFLOAT(16))"));
