...
public class VarCharTypeTests extends BaseTestCase
{
	private static final Logger _logger =  LoggerFactory.getLogger(VarCharTypeTests.class.getName());

	public VarCharTypeTests()
	{
		super();
	...
	public static void createTable()
	{
		...
		Mono<Void> mono = getNewConnection()
								...
								.flatMap(c -> c.executeUpdate("CREATE TABLE UNIT_TEST_"+_randomInt + " (ID INTEGER, NAME VARCHAR(25) NOT NULL, ALIAS_NAME VARCHAR(25))"));
	...
	@Test  
	public void test001CreateTableWithVarColumn()
	{
		AtomicReference<DB2Connection> con = new AtomicReference<DB2Connection>();
		
		Mono<Void> mono = getNewConnection()
								.doOnNext(c -> con.set(c))
								.flatMap(c -> c.executeUpdate("CREATE TABLE UNIT_TEST_1_"+_randomInt + " (C VARCHAR(10))"));
	...
	@Test  
	public void test002DropTableWithVarColumn()
	{
		AtomicReference<DB2Connection> con = new AtomicReference<DB2Connection>();
