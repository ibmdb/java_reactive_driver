 ...
 */
/**
 * Tests for CLOB using UTF-8 encoding.
 */
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class CLOBUnicodeTests extends BaseTestCase
{
	private static final Logger _logger =  LoggerFactory.getLogger(CLOBUnicodeTests.class.getName());
	...
	public static void createTable()
	{
		...
		Mono<Void> mono = getNewConnection()
			...
			.flatMap(c -> c.executeUpdate("CREATE TABLE UNIT_TEST_"+_randomInt + " (ID INTEGER UNIQUE NOT NULL, DATA1 CLOB, DATA2 CLOB(10M)) CCSID UNICODE"));
	...
	public void test101Select()
	{
		...
		for (int i = 0; i < 100; i++) {
			isb1.append(i+". "+"Best Wishes | வாழ்த்துகள் | ಶುಭಾಷಯಗಳು | శుభాకాంక్షలు | शुभकामनाएं | ਸ਼ੁਭ ਕਾਮਨਾਵਾਂ  | 幸運をお祈りしています | 最好的祝愿 | 최고의 소원 | С наилучшими пожеланиями | أهلا بك | \n");
			isb1.append(i+". "+"₹ € £ $ ¥ ∫ ∂ δ α Β Ɣ \n");
		}
	...
	public void test104Select()
	{
		...
		for (int i = 0; i < 100; i++) {
			isb3.append(i+". "+"Best Wishes | வாழ்த்துகள் | ಶುಭಾಷಯಗಳು | శుభాకాంక్షలు | शुभकामनाएं | ਸ਼ੁਭ ਕਾਮਨਾਵਾਂ  | 幸運をお祈りしています | 最好的祝愿 | 최고의 소원 | С наилучшими пожеланиями | أهلا بك | \n");
			isb3.append(i+". "+"₹ € £ $ ¥ ∫ ∂ δ α Β Ɣ \n");
		}
