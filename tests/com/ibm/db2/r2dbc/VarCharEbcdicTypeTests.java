...
public class VarCharEbcdicTypeTests extends BaseTestCase
{
	private static final Logger _logger =  LoggerFactory.getLogger(VarCharEbcdicTypeTests.class.getName());

	public VarCharEbcdicTypeTests()
	{
		super();
	...
	public static void createEBCDICTableA()
	{
		...
		if (_isLUW) {
			...
			createTable = "CREATE TABLE UNIT_TEST_E_A_"+_randomInt + " (NAME VARCHAR(25))";
		}
		else {
			createTable = "CREATE TABLE UNIT_TEST_E_A_"+_randomInt + " (NAME VARCHAR(25)) CCSID EBCDIC";
		}
	...
	public static void createEBCDICTableB()
	{
		...
		String createTable;
		if (_isLUW) {
			// FOR SBCS and CCIS EBCDIC are invalid for LUW
			createTable = "CREATE TABLE UNIT_TEST_E_B_"+_randomInt + " (NAME VARCHAR(25))";
		}
		else {
			createTable = "CREATE TABLE UNIT_TEST_E_B_"+_randomInt + " (NAME VARCHAR(25) FOR SBCS DATA) CCSID EBCDIC";
		}
		Mono<Void> mono = getNewConnection()
								.doOnNext(c -> con.set(c))
								.flatMap(c -> c.executeUpdate(createTable));
	...
	public static void createEBCDICTableC()
	{
		...
		String createTable;
		if (_isLUW) {
			// CCSID EBCDIC is invalid inLUW also BIT DATA has limitations
			createTable = "CREATE TABLE UNIT_TEST_E_C_"+_randomInt + " (NAME VARCHAR(25))";
		}
		else {
			createTable = "CREATE TABLE UNIT_TEST_E_C_"+_randomInt + " (NAME VARCHAR(25) FOR BIT DATA) CCSID EBCDIC";
		}
		Mono<Void> mono = getNewConnection()
								.doOnNext(c -> con.set(c))
								.flatMap(c -> c.executeUpdate(createTable));
	...
	public static void createEBCDICTableD()
	{
		...
		String createTable;
		if (_isLUW) {
			// CCSID 1208 and CCSID EBCDIC are invalid for LUW
			createTable = "CREATE TABLE UNIT_TEST_E_D_"+_randomInt + " (NAME VARCHAR(25))";
		}
		else {
			createTable = "CREATE TABLE UNIT_TEST_E_D_"+_randomInt + " (NAME VARCHAR(25) CCSID 1208) CCSID EBCDIC";
		}
		Mono<Void> mono = getNewConnection()
								.doOnNext(c -> con.set(c))
								.flatMap(c -> c.executeUpdate(createTable));
