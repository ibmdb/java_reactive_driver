...
public class DecFloat34TypeTests extends BaseTestCase
{
	private static final Logger _logger =  LoggerFactory.getLogger(DecFloat34TypeTests.class.getName());

	public DecFloat34TypeTests()
	{
		super();
	...
	public static void createTable()
	{
		...
		Mono<Void> mono = getNewConnection()
								...
								.flatMap(c -> c.executeUpdate("CREATE TABLE UNIT_TEST_"+_randomInt + " (ID INTEGER, AMOUNT DECFLOAT(34) NOT NULL, ALIAS_AMOUNT DECFLOAT(34))"));
	...
	public void test001CreateTableWithDecimalColumn()
	{
		...
		Mono<Void> mono = getNewConnection()
								.doOnNext(c -> con.set(c))
								.flatMap(c -> c.executeUpdate("CREATE TABLE UNIT_TEST_1_"+_randomInt + " (ID DECFLOAT(34))"));
